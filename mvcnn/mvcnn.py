...
class MVCNN(Model):
    ...
    def __init__(self, svcnn: SVCNN, n_classes: int) -> None:
        ...
        fc_1 = nn.Linear(svcnn.embedding_size, hidden_layer_size)
        relu_1 = nn.ReLU()
        dropout_1 = nn.Dropout(0.5)
        fc_2 = nn.Linear(hidden_layer_size, hidden_layer_size)
        relu_2 = nn.ReLU()
        dropout_2 = nn.Dropout(0.5)
        fc_3 = nn.Linear(hidden_layer_size, n_classes)
        ...
        torch.save(
            {
                ...
                "classifier": self._net.state_dict(),
            },
            path,
        )
    ...
    def load(self, path: Path) -> None:
        ...
        self._net.load_state_dict(checkpoint["classifier"])
